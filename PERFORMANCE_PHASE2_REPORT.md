...
| `cmd /c npm run audit:release` | Passed; regenerated `scripts/release/repository-hardening-audit.md`. |
...
| P1 | Split `/owner/orders` and selected owner settings sections. | Needs authenticated owner smoke. |
