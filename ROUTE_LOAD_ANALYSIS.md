...
| --- | --- | --- |
| P1 | Split `/owner/orders` active-order/timeline/payment dialogs. | Requires authenticated owner workflow smoke. |
| P1 | Split profile tabs after browser smoke. | Current startup improved enough for rc3; deeper split is higher regression risk. |
