...
Generated: 2026-07-08T05:34:57.250Z
...
| listener-lifecycle | 48 | Realtime/listener site; verify cleanup and reconnect bounds. |
...
- `src/hooks/use-realtime-order.ts` (1)
- `src/components/flows/kitchen-display-flow.tsx` (8)
