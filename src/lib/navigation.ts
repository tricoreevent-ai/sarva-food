...
export const ownerNav: NavItem[] = [
  ...
  { label: "Kitchen Order History", href: "/owner/kitchen/history", icon: FileText, featureKey: "kitchen" },
  ...
  { label: "Customers", href: "/owner/customers", icon: Users, featureKey: "customers" },
  ...
  { label: "Audit Logs", href: "/owner/audit-logs", icon: ScrollText, featureKey: "auditLogs", minimumPlan: "Growth" },
