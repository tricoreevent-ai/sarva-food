  ...
  return (
    <div className="space-y-6">
      ...
      <Card><CardContent className="grid gap-3 p-4 lg:grid-cols-[auto_repeat(4,minmax(0,1fr))]">
        ...
        <FilterSelect label="Status" value={filters.status} values={["all", "new", "accepted", "preparing", "ready", "served", "completed", "cancelled", "rejected"]} onChange={(status) => setFilters((current) => ({ ...current, status }))} />
