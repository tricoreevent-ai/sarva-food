...
| --- | --- | --- | --- |
| `/api/release-info` | FAIL | SHA matches `dcff59e050de1dace19460198cb2909372bce7d5`, Node `v22.18.0`, but `applicationVersion=v1.0.0-rc4` and `deploymentEnvironment=development`. | `applicationVersion=v1.0.0-rc5`, `deploymentEnvironment=production`, correct SHA, Node 22. |
