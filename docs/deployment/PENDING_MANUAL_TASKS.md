...
| 🟡 Pending Manual | Active Orders multi-role QA | Verify Owner, Manager, Waiter, Cashier, and Kitchen flows for Serve, Complete, Collect Payment, Preview, Print, Reminder, Transfer, Split, Merge, Timeline, History, Kitchen Recall, and Assign Waiter. | Hosted runtime matches repository lifecycle and no action is dead or duplicated. |
