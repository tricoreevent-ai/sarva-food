...
| 🟡 Pending Manual | Hosted runtime smoke | Run authenticated Owner Active Orders, Owner Reports/Dashboard, customer, POS, Kitchen, QR/table, and admin smoke on hosted RC6.5 runtime. | No P0/P1 browser console, stale counter/report, workflow, duplicate notification/KOT/order, or responsive issue. |
