...
| --- | ---: |
| discoveryMs | 0.194 |
| registryLookupMs | 0.347 |
| validationMs | 0.092 |
| dependencyResolutionMs | 0.647 |
| runtimeCreationMs | 0.119 |
| contextInjectionMs | 0.147 |
| sdkInjectionMs | 0.120 |
| uiRegistrationMs | 0.132 |
| routeRegistrationMs | 0.149 |
| navigationRegistrationMs | 0.252 |
| pluginEnableMs | 0.107 |
| pluginDisableMs | 0.048 |
| pluginDestroyMs | 0.043 |
| eventPublishMs | 2.949 |
| storageWriteMs | 1.624 |
| storageReadMs | 2.800 |
| rapidEnableDisableMs | 0.515 |
| lazyLoadUnloadMs | 0.290 |
