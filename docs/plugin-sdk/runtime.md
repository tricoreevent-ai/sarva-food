...
`src/plugins/core/runtime` starts, disables, suspends, resumes, reloads, uninstalls, unloads, and destroys plugins through lifecycle, registry, loader, context, sandbox, UI, route, asset, and health services.
