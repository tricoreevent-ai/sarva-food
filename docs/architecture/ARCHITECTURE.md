...
For complete feature details, see `docs/architecture/EXISTING_FEATURES.md`.
...
- `docs/architecture/frontend-flows.md`
- `docs/architecture/firestore-schema.md`
- `docs/deployment/firebase-setup.md`
- `docs/guides/pwa-strategy.md`
- `docs/architecture/routing.md`
- `docs/architecture/state-management.md`
- `docs/architecture/social-commerce.md`

Use `docs/guides/developer-guide.md` and `docs/architecture/architecture-audit.md` as the canonical starting points for future enhancements.
...
- `docs/guides/help-customer-module.md` - Customer ordering, discovery, profile, account management features.
- `docs/guides/help-owner-module.md` - Owner menu management, offers, staff, settings, and profile features.
- `docs/guides/help-pos-module.md` - POS billing, table management, invoice generation features.

### Operational Features
- `docs/architecture/restaurant-operations-system.md` - Table ordering, kitchen workflow, thermal printer integration, digital menu display, social approval workflow.
- `docs/architecture/restaurant-business-suite.md` - Theme system, i18n, parcel flow, delivery, loyalty, inventory, supplier, accounting, QR ordering.
- `docs/architecture/restaurant-enterprise-features.md` - Waiter flow, KDS, printer support, menu system, digital signage, offers, staff roles, reporting, accounting, inventory, multi-branch, offline strategy.

### Social & Commerce
- `docs/architecture/social-commerce.md` - Instagram deep linking, WhatsApp integration, metadata handling, conversion UX, analytics events.

### Business & Operational Management
- `docs/architecture/restaurant-billing-printing-system.md` - Receipt templates, GST setup, print modes (58mm, 80mm, A4), branding, settings.
- `docs/architecture/restaurant-printing-system.md` - Bill composition, KOT format, print quality, settings.

### Owner Manual & Guidance
- `docs/guides/owner-user-manual.md` - Menu management, order lifecycle, kitchen tickets, in-store table management, social commerce, image optimization, cost efficiency, troubleshooting.
- `docs/trackers/project-tracker.md` - Enterprise phase tracker and offer consolidation details.

### Complete Feature List
- `docs/architecture/EXISTING_FEATURES.md` - Comprehensive reference of all existing features organized by module and capability.

### Technical & Architecture
- `docs/guides/developer-guide.md` - Developer setup, code patterns, best practices.
- `docs/architecture/architecture-audit.md` - Detailed audit of system architecture and design decisions.
- `docs/architecture/frontend-flows.md` - User journey flows and state management patterns.
- `docs/architecture/firestore-schema.md` - Complete database schema and collection structure.
- `docs/deployment/firebase-setup.md` - Firebase configuration and initialization.
- `docs/architecture/backend-architecture.md` - Backend services and API layer.

### Deployment & Infrastructure
- `docs/deployment/deployment.md` - Deployment procedures and environments.
- `docs/deployment/HOSTINGER_DEPLOYMENT_GUIDE.md` - Hostinger-specific deployment configuration.
- `docs/guides/pwa-strategy.md` - Progressive Web App implementation details.
- `docs/deployment/firebase-setup.md` - Firebase project configuration.
- `docs/firebase-production-integration.md` - Production Firebase integration checklist.

### Performance & Optimization
- `docs/performance/performance-audit.md` - Performance analysis and optimization recommendations.
- `docs/performance/nextjs-optimization.md` - Next.js-specific optimizations and configurations.
- `docs/performance/firebase-cost-optimization.md` - Firebase cost reduction strategies.

### Security & Compliance
- `docs/architecture/security-rules.md` - Firestore security rules and access control.
- `docs/validation/firestore-rule-failures.md` - Rule failure diagnosis and fixes.

### Troubleshooting & Diagnostics
- `docs/deployment/firebase-troubleshooting.md` - Firebase common issues and solutions.
- `docs/performance/firebase-runtime-audit.md` - Runtime Firebase audit findings.
- `docs/validation/root-cause-analysis.md` - Analysis of root causes for reported issues.
- `docs/validation/reconciliation-report.md` - Data parity and reconciliation findings.

### Release & Project Status
- `docs/trackers/TASK_TRACKER.md` - Active and completed task tracking.
...
- Dev tooling: `scripts/`
- Complete feature list: `docs/architecture/EXISTING_FEATURES.md`
